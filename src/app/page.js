      ...
      <section style={{
        ...
        <div style={{ flex: 1, minWidth: '300px' }}>
          ...
          <div style={{ display: 'flex', gap: '1rem' }}>
            ...
            <a href="https://drive.google.com/file/d/18H31tRpfZEU1VGBvWAZPyiMKs5E7wGJ2/view?usp=sharing" target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'none' }}>
              <button style={{
